---
title: "FASTX ALTREP Conformance Checks"
...
Executable conformance checks for the chunked FASTA/FASTQ iterator. This report
is outside `vignettes/` and ignored by `R CMD build`; run it with:
